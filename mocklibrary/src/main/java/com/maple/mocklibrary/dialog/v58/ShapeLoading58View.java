...
public class ShapeLoading58View extends View {


    private static final float genhao3 = 1.7320508075689f;
    private static final float mTriangle2Circle = 0.25555555f;

    private ShapeLoading58View.Shape mShape = ShapeLoading58View.Shape.SHAPE_CIRCLE;
    ...
    public ShapeLoading58View(Context context) {
        super(context);
        init();
    }

    public ShapeLoading58View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ShapeLoading58View(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ShapeLoading58View(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        switch (mShape) {
            case SHAPE_TRIANGLE:
                ...
                if (mIsLoading) {
                    ...
                    if (mAnimPercent >= 1) {
                        mShape = ShapeLoading58View.Shape.SHAPE_CIRCLE;
                        mIsLoading = false;
                        mAnimPercent = 1;
                    }
            ...
            case SHAPE_CIRCLE:
                ...
                if (mIsLoading) {
                    ...
                    if (magicNumber + mAnimPercent >= 1.9f) {
                        mShape = ShapeLoading58View.Shape.SHAPE_RECT;
                        mIsLoading = false;
                    }
            ...
            case SHAPE_RECT:
                ...
                if (mIsLoading) {
                    ...
                    mAnimPercent += 0.15;
                    if (mAnimPercent >= 1) {
                        mShape = ShapeLoading58View.Shape.SHAPE_TRIANGLE;
                        mIsLoading = false;
                        mAnimPercent = 1;
                    }
    ...
    public ShapeLoading58View.Shape getShape() {
        return mShape;
    }
}