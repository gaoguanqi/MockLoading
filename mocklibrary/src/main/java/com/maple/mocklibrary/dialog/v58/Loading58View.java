...
public class Loading58View extends FrameLayout {

    private static final int ANIMATION_DURATION = 500;

    private static float mDistance = 200;

    private ShapeLoading58View mShapeLoadingView;
    ...
    public Loading58View(Context context, AttributeSet attrs) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context
                .obtainStyledAttributes(attrs, R.styleable.Loading58View);
        mLoadText = typedArray.getString(R.styleable.Loading58View_loadingText);
        mTextAppearance = typedArray.getResourceId(R.styleable.Loading58View_loadingTextAppearance, -1);

        typedArray.recycle();
    }


    public Loading58View(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public Loading58View(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onFinishInflate() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.loading_58_view, null);

        mDistance = dip2px(42f);

        LayoutParams layoutParams = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);

        layoutParams.gravity = Gravity.CENTER;

        mShapeLoadingView = (ShapeLoading58View) view.findViewById(R.id.shapeLoadingView);
